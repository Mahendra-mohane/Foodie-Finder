...
let  showbtan=document.querySelector('#form_page')
...
//  use this code to make sliding sigin 

let registersigninbtn=document.querySelector('#sign-in')

 registersigninbtn.addEventListener('click',()=>{
  document.querySelector('.overlay').classList.add('showoverlay')
      document.querySelector('.loginform').classList.add('showloginform')
 })
...
//  registersigninbtn.addEventListener('click',()=>{
//   document.querySelector('.overlay').classList.add('showoverlay')
//       document.querySelector('.signup-form').classList.add('form')
//  })




//code for sign in in navbar//
